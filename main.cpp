...
//     {   
//         int n;
//         cout<<"Enter a number (-1 to exit): "<<endl<<"1. for account operations"<<endl<<"2.for checking account operations"<<endl<<"3.for savings account operations"<<endl<<"4.for trust account operations"<<endl;
//         cin>>n;
//         switch(n)
//         {
//             case 1:
...
//             {
//             int choice;
//             cout<<"1. Create Account"<<endl<<"2.deposit"<<endl<<"3.withdraw"<<endl<<"4.display account details"<<endl;
//             cin>>choice;
//             switch(choice)
//             {
//                 case 1:
...
//                     cin>>balance;
//                     accounts.push_back(make_unique<Account>(accno, name, balance));
//                     break;
//                 }
//                 case 2:
//                 {
...
//                     int accno;
//                     cin>>accno;
//                     if(find_account(accounts,accno))
//                     {
//                         find_account(accounts,accno)->deposit(amount);
//                     }
//                     else
//                     {
...
//                     if(find_account(accounts,accno))
//                     {
//                         find_account(accounts,accno)->withdraw(amount);
//                     }
//                     else
//                     {
//                         cout<<"Account not found"<<endl;
...
//                     if(find_account(accounts,accno))
//                     {
//                         cout<<*(find_account(accounts,accno))<<endl;
//                     }
//                     else
//                     {
//                         cout<<"Account not found"<<endl;
...
//             {
//             int choice;
//             cout<<"1. Create Checking Account"<<endl<<"2.deposit"<<endl<<"3.withdraw"<<endl<<"4.display account details"<<endl;
//             cin>>choice;
//             switch(choice)
//             {
//                 case 1:
...
//             {
//             int choice;
//             cout<<"1. Create Savings Account"<<endl<<"2.deposit"<<endl<<"3.withdraw"<<endl<<"4.display account details"<<endl;
//             cin>>choice;
//             switch(choice)
//             {
//                 case 1:
...
//             {
//             int choice;
//             cout<<"1. Create Trust Account"<<endl<<"2.deposit"<<endl<<"3.withdraw"<<endl<<"4.display account details"<<endl;
//             cin>>choice;
//             switch(choice)
//             {
//                 case 1:
